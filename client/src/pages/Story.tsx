  ...
  const sortedStory = [
    {
      ...
      title: "İlk Bakışta",
      content:
        "Göz göze geldiğimiz andan itibaren sende olağanüstü bir şey olduğunu anladım. Zaman durmuş gibiydi ve o anda her şey değişti.",
      imageUrl: "/12.jpeg",
      order: 1,
    },
    {
      id: 2,
      title: "Kalplerimizin Yakınlaşması",
      content:
        "Her konuşma, her ortak kahkaha, birlikte geçirdiğimiz her sessiz an bizi birbirimize daha da yaklaştırdı. Seni görmeyi dört gözle beklediğimi, sürekli seni düşündüğümü fark ettim.",
      imageUrl: "/6.jpeg",
      order: 2,
    },
    {
      id: 3,
      title: "Aşkın Derinliklerine",
      content:
        "Bir şekilde, dostluğumuz daha fazlasına dönüştü. Sesini duyduğumda kalbim hızla çarpardı ve gülümsemen en sevdiğim görüntü oldu.",
      imageUrl: "/4.jpeg",
      order: 3,
    },
  ];
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          >
            ...
            >
              Seninle geçirdiğim her an, sonsuza dek saklanmayı bekleyen en
              güzel anılardan biri.
            </motion.p>
          </motion.div>
        ...
        >
          ...
          <div className="relative z-10 space-y-6 sm:space-y-8 text-center">
            ...
            >
              Ama dur, hikayemizin devamı da var...
            </motion.p>
            ...
            >
              Her resim binlerce kelimeyle sevgimizi anlatıyor.
            </motion.p>
          </div>
        </motion.div>
      </div>
