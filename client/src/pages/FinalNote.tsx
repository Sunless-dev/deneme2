...
export default function FinalNote() {
  ...
  const fullText =
    "Seni sevmek yaptığım bir şey değil, kim olduğumun bir parçası. Her nefesimde, her sessizliğimde, her yarınımda, sensin. Kalbimin, aşkı henüz anlamadan çok önce seçtiği kişiye Sevgililer Günü kutlu olsun.";
      ...
      <div className="w-full max-w-3xl relative z-10">
        ...
        >
          ...
          <p className="text-xs sm:text-sm text-gray-500 italic">
            Sevgiyle yapıldı, sadece senin için.
          </p>
        </motion.div>
      </div>
    </div>
