    ...
    >
      ...
      >
        ...
        >
          ...
          >
            Bunu çok uzun zamandır kalbimde taşıyordum…
          </motion.span>
          ...
          >
            <p className="text-sm sm:text-base md:text-lg text-rose-700/80 font-light italic leading-relaxed px-4">
              Hayatıma girdiğin günden beri her an,
              <br />
              <span className="text-pink-600/90">
                Evren biraz daha büyülü geliyor.
              </span>
            </p>
          </motion.div>
        </motion.div>
        ...
        >
          <motion.button
            ...
            aria-label="Maceramıza Başlayalım"
          >
        ...
        >
          ...
          >
            Hazır olduğunda kalbe basabilirsin…
          </motion.p>

          <p className="text-pink-500/60 text-xs sm:text-sm italic">
            (Bazı duygular aceleye getirilemeyecek kadar kıymetlidir.)
          </p>
        </motion.div>
